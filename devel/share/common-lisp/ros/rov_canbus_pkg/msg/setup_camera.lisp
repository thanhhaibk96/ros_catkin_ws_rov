...
(cl:defclass <setup_camera> (roslisp-msg-protocol:ros-message)
  ((camera_zoom
    :reader camera_zoom
    :initarg :camera_zoom
    :type cl:fixnum
...
(cl:defclass setup_camera (<setup_camera>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <setup_camera>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'setup_camera)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rov_canbus_pkg-msg:<setup_camera> is deprecated: use rov_canbus_pkg-msg:setup_camera instead.")))

(cl:ensure-generic-function 'camera_zoom-val :lambda-list '(m))
(cl:defmethod camera_zoom-val ((m <setup_camera>))
...
(cl:defmethod camera_focus-val ((m <setup_camera>))
...
(cl:defmethod camera_bright-val ((m <setup_camera>))
  ...
  (camera_bright m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <setup_camera>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <setup_camera>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<setup_camera>)))
  "Returns string type for a message object of type '<setup_camera>"
  "rov_canbus_pkg/setup_camera")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'setup_camera)))
  "Returns string type for a message object of type 'setup_camera"
  "rov_canbus_pkg/setup_camera")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<setup_camera>)))
  "Returns md5sum for a message object of type '<setup_camera>"
  "6554d73da328aadf658777e841366a86")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'setup_camera)))
  "Returns md5sum for a message object of type 'setup_camera"
  "6554d73da328aadf658777e841366a86")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<setup_camera>)))
  "Returns full string definition for message of type '<setup_camera>"
  (cl:format cl:nil "uint8 camera_zoom~%uint8 camera_focus~%uint8 camera_bright~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'setup_camera)))
  "Returns full string definition for message of type 'setup_camera"
  (cl:format cl:nil "uint8 camera_zoom~%uint8 camera_focus~%uint8 camera_bright~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <setup_camera>))
  (cl:+ 0
     1
     1
     1
))
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <setup_camera>))
  "Converts a ROS message object to a list"
  (cl:list 'setup_camera
