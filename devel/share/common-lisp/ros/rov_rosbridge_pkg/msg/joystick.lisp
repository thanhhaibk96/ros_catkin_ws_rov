...
(cl:defclass <joystick> (roslisp-msg-protocol:ros-message)
  ((thruster
    :reader thruster
    :initarg :thruster
    :type rov_rosbridge_pkg-msg:my_thruster
    :initform (cl:make-instance 'rov_rosbridge_pkg-msg:my_thruster)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <joystick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joystick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name rov_rosbridge_pkg-msg:<joystick> is deprecated: use rov_rosbridge_pkg-msg:joystick instead.")))

(cl:ensure-generic-function 'thruster-val :lambda-list '(m))
(cl:defmethod thruster-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader rov_rosbridge_pkg-msg:thruster-val is deprecated.  Use rov_rosbridge_pkg-msg:thruster instead.")
  (thruster m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<joystick>)))
  ...
  (cl:format cl:nil "my_thruster thruster~%================================================================================~%MSG: rov_rosbridge_pkg/my_thruster~%float64 bldc~%float64 green_1~%float64 green_2~%float64 yellow_1~%float64 yellow_2~%float64 yellow_3~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'joystick)))
  "Returns full string definition for message of type 'joystick"
  (cl:format cl:nil "my_thruster thruster~%================================================================================~%MSG: rov_rosbridge_pkg/my_thruster~%float64 bldc~%float64 green_1~%float64 green_2~%float64 yellow_1~%float64 yellow_2~%float64 yellow_3~%~%"))
